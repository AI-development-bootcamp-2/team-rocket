...
- [x] T055 Ensure all numeric fields in response are rounded to max 2 decimal places (no floating-point noise)
- [x] T056 [P] Add `401` test: missing JWT → `authenticate` middleware rejects before handler runs
