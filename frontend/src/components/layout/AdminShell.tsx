        ...
        <div className="admin-sidebar__footer">
          <div className="admin-user-profile">
                ...
                <defs>
                  <clipPath id="clip0_11200_14258">
                    <rect
                      ...
                      height="20"
                      fill="white"
                      transform="translate(6.66699 10)"
                    />
                  </clipPath>
                </defs>
              </svg>
            ...
            <div className="admin-user-profile__info">
              ...
              <button type="button" className="admin-user-profile__logout" onClick={logout}>
                התנתקות
              </button>
            </div>
          </div>
